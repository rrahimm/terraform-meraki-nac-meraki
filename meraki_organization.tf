    ...
    for domain in try(local.meraki.domains, []) : [
      for organization in try(domain.organizations, []) : [
        for smart_port_profile in try(organization.smart_port_profiles, []) : {
          ...
          port_type                           = try(smart_port_profile.port.type, local.defaults.meraki.domains.organizations.smart_port_profiles.port.type, null)
          port_vlan                           = try(smart_port_profile.port.vlan, local.defaults.meraki.domains.organizations.smart_port_profiles.port.vlan, null)
          port_voice_vlan                     = try(smart_port_profile.port.voice_vlan, local.defaults.meraki.domains.organizations.smart_port_profiles.port.voice_vlan, null)
          port_allowed_vlans                  = try(smart_port_profile.port.allowed_vlans, local.defaults.meraki.domains.organizations.smart_port_profiles.port.allowed_vlans, null)
          port_poe_enabled                    = try(smart_port_profile.port.poe, local.defaults.meraki.domains.organizations.smart_port_profiles.port.poe, null)
          port_isolation_enabled              = try(smart_port_profile.port.isolation, local.defaults.meraki.domains.organizations.smart_port_profiles.port.isolation, null)
          port_rstp_enabled                   = try(smart_port_profile.port.rstp, local.defaults.meraki.domains.organizations.smart_port_profiles.port.rstp, null)
          port_stp_guard                      = try(smart_port_profile.port.stp_guard, local.defaults.meraki.domains.organizations.smart_port_profiles.port.stp_guard, null)
          port_udld                           = try(smart_port_profile.port.udld, local.defaults.meraki.domains.organizations.smart_port_profiles.port.udld, null)
          port_access_policy_type             = try(smart_port_profile.port.access_policy_type, local.defaults.meraki.domains.organizations.smart_port_profiles.port.access_policy_type, null)
          port_access_policy_number           = try(smart_port_profile.port.access_policy_number, local.defaults.meraki.domains.organizations.smart_port_profiles.port.access_policy_number, null)
          port_mac_allow_list                 = try(smart_port_profile.port.mac_allow_list, local.defaults.meraki.domains.organizations.smart_port_profiles.port.mac_allow_list, null)
          port_sticky_mac_allow_list          = try(smart_port_profile.port.sticky_mac_allow_list, local.defaults.meraki.domains.organizations.smart_port_profiles.port.sticky_mac_allow_list, null)
          port_sticky_mac_allow_list_limit    = try(smart_port_profile.port.sticky_mac_allow_list_limit, local.defaults.meraki.domains.organizations.smart_port_profiles.port.sticky_mac_allow_list_limit, null)
          port_storm_control_enabled          = try(smart_port_profile.port.storm_control, local.defaults.meraki.domains.organizations.smart_port_profiles.port.storm_control, null)
          port_adaptive_policy_group_id       = try(smart_port_profile.port.adaptive_policy_group_id, local.defaults.meraki.domains.organizations.smart_port_profiles.port.adaptive_policy_group_id, null)
          port_adaptive_policy_voice_group_id = try(smart_port_profile.port.adaptive_policy_voice_group_id, local.defaults.meraki.domains.organizations.smart_port_profiles.port.adaptive_policy_voice_group_id, null)
          port_peer_sgt_capable               = try(smart_port_profile.port.peer_sgt_capable, local.defaults.meraki.domains.organizations.smart_port_profiles.port.peer_sgt_capable, null)
          port_dai_trusted                    = try(smart_port_profile.port.dai_trusted, local.defaults.meraki.domains.organizations.smart_port_profiles.port.dai_trusted, null)
        }
      ]
    ]
  ])
